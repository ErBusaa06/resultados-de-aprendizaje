        ...
        <html>
            ...
            <body>
                ...
                <div class="sub-title2">
                    <xsl:value-of select="//Modulo[@cod='5071']/@nombre" />
                </div>
                    ...
                    <div id="customAccordion" class="custom-accordion">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#customAccordion">
                                <div class="card-body">
                                    El módulo de Modelos de Inteligencia Artificial tiene como objetivo principal capacitar para aplicar sistemas de inteligencia artificial que mejoren la productividad y faciliten la toma de decisiones ágiles en las organizaciones. Se enfoca en el manejo y explotación de datos masivos para gestionar la transformación digital y la eficiencia empresarial. Además, busca desarrollar la habilidad para implantar funcionalidades, procesos y sistemas de decisión basados en inteligencia artificial, así como para gestionar planes de cambio y mejora de procesos dentro de las empresas. Este módulo también promueve la gestión de diferentes tipos de inteligencia artificial para impulsar la transformación y el cambio organizacional, contribuyendo así a la automatización y optimización de procesos empresariales.
                                </div>
                            </div>
                        </div>
